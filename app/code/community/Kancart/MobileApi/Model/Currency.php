...
class Kancart_MobileApi_Model_Currency extends Kancart_MobileApi_Model_Abstract {
    ...
    public function getCurrencies() {
        ...
        $result->setResult('0x0000', array('currencies' => $this->formatCurrency($currency)));
        return $result->returnResult();
    }

    public function formatCurrency($currencyCode) {
        $currency = Mage::getModel('currencysymbol/system_currencysymbol');
        $currencyData = $currency->getCurrencySymbolsData();
        $currencies = array();
